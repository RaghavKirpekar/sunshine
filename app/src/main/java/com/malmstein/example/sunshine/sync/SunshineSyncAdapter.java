package com.malmstein.example.sunshine.sync;
...
import com.malmstein.example.sunshine.WeatherActivity;
...
import static com.malmstein.example.sunshine.data.WeatherContract.LocationEntry;
import static com.malmstein.example.sunshine.data.WeatherContract.WeatherEntry;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void notifyWeather() {
        ...
        boolean displayNotification = prefs.getBoolean(context.getString(R.string.pref_enable_notifications_key),
